...
const Navigation = () => {
    ...
    return (
        <header className="fixed top-0 left-0 w-full  shadow-md z-50 py-4 " style={{ background: theme.palette.background.main }}>            <div className="container mx-auto flex items-center justify-between px-4">
            {/* Logo */}
